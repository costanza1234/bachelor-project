...
To do this, the tool was designed as an interactive web-based game where children answer questions with a neutral, positive or negative emotioan tone by choosing between two search tools. Their choices, search behavior, and answers are logged to generate structured data with reaserch purposes. This allows to later analyze aspects such as tool preference, emotional influences, and performance across tasks.

This report is structured as follows:
\begin{itemize}
    \item Section 2 reviews background research and related work, providing a motivation for the project.
    ...
    \item Section 6 concludes the report with a discussion on results and outlines directions for future work.
\end{itemize}
