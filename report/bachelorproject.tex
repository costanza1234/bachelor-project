...
\begin{enumerate}
    ...
    \item In classroom settings in Ticino, where the experts work, children typically begin using Google in third grade under close guidance. At this stage, they struggle with navigating the SERP (Search Engine Results Page), switching between tabs, and identifying which results to click on.
