...
\cite{Aliannejadi2021} \cite{Amin2022} \cite{Chen2022} \cite{Imazu2017} \cite{Landoni2020} \cite{Landoni2021} \cite{Landoni2021b} \cite{Landoni2021c} \cite{Rutter2019} \cite{Shiga2017}
\cite{Tapola2022}
...
\newpage
\section{\textbf{Usage Scenarios and Future Work}}
